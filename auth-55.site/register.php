			...
			if ((validationLoginLenth($_POST['login'])==true) and
				...
				if ($_POST['password'] == $_POST['confirm']) {
					...
					if (empty($login_user)) {
						...
						$query = "INSERT INTO user (login, password, user_name, middle_names, surname, date, email, registration_date, country, status_id) VALUES ('$login', '$password', '$user_name', '$middle_names', '$surname', '$date', '$email', CURRENT_DATE(), '$country', '1')";
